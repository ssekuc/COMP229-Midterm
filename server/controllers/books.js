...
export function displayAddPage(req, res, next) {
     ...
     res.render('index', { title: 'Add Books', page: 'books/edit', books: {}, displayName: UserDisplayName(req) });
}
...
export function displayEditPage(req, res, next) {
     ...
     booksModel.findById(id, (err, book) => {
         ...
         res.render('index', { title: 'Edit Book', page: 'books/edit', books: book, displayName: UserDisplayName(req) });
     });  
